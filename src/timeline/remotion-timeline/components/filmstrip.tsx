...
import type { FrameDatabaseKey } from "../utils/frame-database";
import {
  aspectRatioCache,
  clearOldFrames,
  frameDatabase,
...
export const FilmStripFrames: React.FC<{
  readonly src: string;
  readonly visualizationWidth: number;
  readonly startFrom: number;
  readonly durationInFrames: number;
  readonly fps: number;
}> = ({ src, visualizationWidth, startFrom, durationInFrames, fps }) => {
